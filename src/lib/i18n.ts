export const translations = {
  "pt-BR": {
    app: {
      ...
      subtitle:
        "Pesquise e explore aplicativos do Gerenciador de Pacotes do Windows",
    },
    search: {
      ...
      showingLimited:
        "Exibindo {{showing}} de {{total}} pacotes. Use a busca para ver mais.",
    ...
    emptyState: {
      ...
      withSearch:
        'Nenhum pacote corresponde a "{{query}}". Tente um termo diferente ou limpe seus filtros.',
      withoutSearch: "Comece pesquisando por nome de pacote, ID ou editor.",
    },
    alerts: {
      mockData:
        "Não foi possível conectar à API do GitHub. Exibindo dados de exemplo.",
      staticData:
        "Exibindo dados de pacotes pré-processados - atualizados semanalmente",
      apiData:
    ...
    footer: {
      about: "Sobre",
      description:
        "O Explorador de Pacotes Winget é uma interface web para pesquisar e descobrir aplicativos disponíveis no Windows Package Manager (winget). Os dados são atualizados semanalmente a partir do repositório oficial microsoft/winget-pkgs.",
  ...
  "en-US": {
    ...
    search: {
      ...
      showingLimited:
        "Showing {{showing}} of {{total}} packages. Use search to see more.",
    ...
    emptyState: {
      ...
      withSearch:
        'No packages match "{{query}}". Try a different search term or clear your filters.',
    ...
    footer: {
      about: "About",
      description:
        "Winget Package Explorer is a web interface to search and discover applications available on Windows Package Manager (winget). Data is updated weekly from the official microsoft/winget-pkgs repository.",
  ...
  "es-ES": {
    app: {
      ...
      subtitle:
        "Busca y explora aplicaciones del Administrador de Paquetes de Windows",
    },
    search: {
      ...
      showingLimited:
        "Mostrando {{showing}} de {{total}} paquetes. Use la búsqueda para ver más.",
    ...
    emptyState: {
      ...
      withSearch:
        'Ningún paquete coincide con "{{query}}". Intenta con un término diferente o borra tus filtros.',
      withoutSearch: "Comienza buscando por nombre de paquete, ID o editor.",
    },
    alerts: {
      mockData:
        "No se pudo conectar a la API de GitHub. Mostrando datos de ejemplo.",
      staticData:
        "Mostrando datos de paquetes preprocesados - actualizados semanalmente",
      apiData:
    ...
    footer: {
      about: "Acerca de",
      description:
        "El Explorador de Paquetes Winget es una interfaz web para buscar y descubrir aplicaciones disponibles en Windows Package Manager (winget). Los datos se actualizan semanalmente desde el repositorio oficial microsoft/winget-pkgs.",
  ...
  "fr-FR": {
    app: {
      ...
      subtitle:
        "Recherchez et explorez les applications du Gestionnaire de Paquets Windows",
    },
    search: {
      ...
      showingLimited:
        "Affichage de {{showing}} sur {{total}} paquets. Utilisez la recherche pour en voir plus.",
    ...
    packageDetail: {
      ...
      description: "Description",
      homepage: "Site web",
      downloadUrls: "URLs de Téléchargement",
      installerType: "Type",
      tags: "Tags",
    ...
    emptyState: {
      ...
      withSearch:
        'Aucun paquet ne correspond à "{{query}}". Essayez un terme différent ou effacez vos filtres.',
      withoutSearch:
        "Commencez par rechercher un nom de paquet, ID ou éditeur.",
    },
    alerts: {
      mockData:
        "Impossible de se connecter à l'API GitHub. Affichage de données d'exemple.",
      staticData:
        "Affichage de données de paquets pré-traités - mis à jour chaque semaine",
      apiData:
    ...
    footer: {
      about: "À propos",
      description:
        "L'Explorateur de Paquets Winget est une interface web pour rechercher et découvrir les applications disponibles sur Windows Package Manager (winget). Les données sont mises à jour chaque semaine depuis le dépôt officiel microsoft/winget-pkgs.",
  ...
  "de-DE": {
    ...
    search: {
      ...
      showingLimited:
        "Zeige {{showing}} von {{total}} Paketen. Verwenden Sie die Suche, um mehr zu sehen.",
    ...
    emptyState: {
      ...
      withSearch:
        'Keine Pakete entsprechen "{{query}}". Versuchen Sie einen anderen Suchbegriff oder löschen Sie Ihre Filter.',
      withoutSearch:
        "Beginnen Sie mit der Suche nach einem Paketnamen, einer ID oder einem Herausgeber.",
    },
    alerts: {
      mockData:
        "Verbindung zur GitHub-API nicht möglich. Zeige Beispieldaten an.",
    ...
    footer: {
      about: "Über",
      description:
        "Der Winget Paket-Explorer ist eine Web-Oberfläche zum Suchen und Entdecken von Anwendungen, die im Windows Package Manager (winget) verfügbar sind. Die Daten werden wöchentlich aus dem offiziellen microsoft/winget-pkgs Repository aktualisiert.",
